                ...
                <div class="col-md-3 col-sm-4">
                  ...
                  <div style="margin-top: 15px;">
                    <ul class="nav nav-pills nav-stacked">
                      ...
                      <li class="active"><a href="#"><i class="fa fa-inbox"></i> Unread ({{ $countRequest }})</a></li>
                      <li class=""><a href="{{ route('readrequestform.index') }}"><i class="fa fa-inbox"></i> Read ({{ $countReadRequest }})</a></li>
                    </ul>
                  </div>
                </div><!-- /.col (LEFT) -->
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table table-mailbox">
                      ...
                      <tr>
                        ...
                        <td class="subject"><a href="/requestform/{{ $getMessage->id }}/edit">{{ $getMessage->shortMessage }}</a></td>
