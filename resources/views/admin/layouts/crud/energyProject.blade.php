        ...
        <div class="col-md-8 col-md-push-2">
          ...
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Energy Project</h3>
            </div><!-- /.box-header -->

            <!-- form start -->
            <form role="form" method="post" action="{{ route('energy.store') }}" enctype="multipart/form-data">
              {{ csrf_field() }}
              <div class="box-body">
                  ...
                  <div class="form-group{{ $errors->has('category') ? ' has-error' : '' }}">
                    <input type="hidden" class="form-control" name="category" id="category" value="energy" />
                  </div>
              </div>
