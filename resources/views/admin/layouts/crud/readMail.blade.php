                ...
                <div class="col-md-3 col-sm-4">
                  ...
                  <div style="margin-top: 15px;">
                    <ul class="nav nav-pills nav-stacked">
                      ...
                      <li class=""><a href="{{ route('message.index') }}"><i class="fa fa-inbox"></i> Unread ({{ $countMessages }})</a></li>
                      <li class="active"><a href="#"><i class="fa fa-inbox"></i> Read ({{ $countReadMessages }})</a></li>
                    </ul>
                  </div>
                </div><!-- /.col (LEFT) -->
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table table-mailbox">
                      ...
                      <tr>
                        ...
                        <td class="subject"><a href="/readmessage/{{ $getMessage->id }}/edit">{{ $getMessage->shortMessage }}</a></td>
