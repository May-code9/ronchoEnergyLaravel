      ...
      <div class="row">
        ...
        <div class="col-md-8 col-md-push-2">
          ...
          <div class="box box-success">
            ...
            <!-- form start -->
            <form role="form" method="post" action="/message/{{$getFullMessage->id}}" >
              {{ method_field('PUT') }}
              {{ csrf_field() }}
              <div class="box-body">
                ...
                <div class="form-group col-md-2">
                  ...
                  <input type="text" class="form-control" name="quantity" value="{{ $getFullMessage->quantity }}" disabled/>
                </div>
                ...
                <input type="hidden" class="form-control" name="product_id" value="{{ $getFullMessage->product_id }}" />
                <input type="hidden" class="form-control" name="read" value="1" />
