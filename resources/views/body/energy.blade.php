						...
						<div class="service-content">
							<div class="row">
								<div class="col-md-7 col-sm-7">
									...
									<ul>
										<li>Solar Home & Office Systems (PV, Hybrid)</li>
										<li>Solar for Industrial & Commercial facilities (PV, Hybrid)</li>
										<li>Solar-Enabled Applications (Air-conditioning, water pumps, water-heating, water purification)</li>
										<li>Battery Back-Up (UPS) solutions</li>
										<li>Mini-Grids</li>
										<li>Grid Extension</li>
									</ul>
								...
								<div class="panel panel-default">
									...
									<div id="accordion1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="accordion1">
										<div class="panel-body">
											<p>Perspiciatis unde omnis iste natus error sit voluptatem accu santiumuo doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illomas inventore veritatis et quasi architecto beatae vitae dEnergya sunt explicaon Nemo enim ipsam voluptatem quia voluptas</p>
										</div>
									</div>
								</div>
								<div class="panel panel-default">
