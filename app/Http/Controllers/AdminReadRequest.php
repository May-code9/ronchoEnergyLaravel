...
class AdminReadRequest extends Controller
{
    /**
    ...
    public function index()
    {
      ...
      return view('admin.layouts.crud.readRequest', compact('getMessages', 'countRequest', 'countReadRequest', 'activeRequest'));
    }
    ...
    public function edit($id)
    {
      ...
      ->select('users.first_name', 'users.last_name', 'users.phone_number', 'message', 'product','requests.created_at', 'requests.id', 'user_id')
      ->findOrFail($id);
      return view('admin.layouts.readRequest', compact('getFullMessage'));
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      if($request->has('edit'))
      {
        ...
        return redirect('/requestform')->with("success_status", "Request Marked As UnRead");
      } else {
